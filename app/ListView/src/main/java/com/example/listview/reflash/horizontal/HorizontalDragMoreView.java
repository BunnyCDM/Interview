...
import static com.example.listview.reflash.horizontal.DragState.STATE_IDLE;
...
public class HorizontalDragMoreView extends FrameLayout {
    ...
    public HorizontalDragMoreView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
