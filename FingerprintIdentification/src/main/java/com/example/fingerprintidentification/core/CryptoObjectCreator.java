package com.example.fingerprintidentification.core;
...
public class CryptoObjectCreator {
            ...
            public void run() {
                try {
                    if (mCryptoObject != null) {
                        ...
                        // of the fingerprint.
                        if (!initCipher()) {
                            AppLogger.d("Failed to init Cipher.");
                        }
                    }
                } catch (Exception e) {
                    AppLogger.d(" Failed to init Cipher, e:" + Log.getStackTraceString(e));
                }
    ...
    private void createKey() {
        ...
        try {
            ...
            AppLogger.d(" Failed to createKey, e:" + Log.getStackTraceString(e));
    ...
    private boolean initCipher() {
        try {
            ...
            AppLogger.d(" Failed to initCipher, e:" + Log.getStackTraceString(e));
            return false;
